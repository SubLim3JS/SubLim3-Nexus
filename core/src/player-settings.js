...
export class PlayerSettingsService {
  ...
  async update(input) {
    ...
    const next = {
      ...
      audio_output_device: input.audio_output_device === undefined ? current.audio_output_device : choice(input.audio_output_device, ["pi", "bluetooth", "browser"], "Audio output device"),

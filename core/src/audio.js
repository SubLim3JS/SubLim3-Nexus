...
export const BUILT_IN_AUDIO_ITEMS = [
  ...
  {
    item_id: "radio-iheart-2157",
    name: "iHeart Radio 2157",
    kind: "ambience",
    ...
    loop: false,
    source: { type: "radio", stream_url: "https://stream.revma.ihrhls.com/zc2157" },
  },
  ...
  { item_id: "dice-roll", name: "Dice Roll", kind: "effect", description: "Rattling tabletop dice", tags: ["Table", "Dice"], sort_order: 50, synthesis: { frequencies: [180, 260, 410], wave: "sawtooth", noise: 0.18, duration_seconds: 0.9, pulse: 0.13 } },
  { item_id: "footsteps", name: "Footsteps", kind: "effect", description: "Approaching steps", tags: ["Travel", "Dungeon"], sort_order: 60, synthesis: { frequencies: [82, 96], wave: "sine", noise: 0.11, duration_seconds: 1.8, pulse: 0.42 } },
  { item_id: "trap-click", name: "Trap Click", kind: "effect", description: "Mechanical trigger", tags: ["Dungeon", "Danger"], sort_order: 70, synthesis: { frequencies: [980, 1480, 2100], wave: "square", noise: 0.05, duration_seconds: 0.42 } },
  { item_id: "healing-chime", name: "Healing Chime", kind: "effect", description: "Restorative sparkle", tags: ["Magic", "Healing"], sort_order: 80, synthesis: { frequencies: [523.25, 659.25, 783.99, 1046.5], wave: "sine", noise: 0.005, duration_seconds: 1.35 } },
  { item_id: "system-boot-ready", name: "Boot Ready", kind: "effect", description: "Nexus is ready", tags: ["System"], sort_order: 890, synthesis: { frequencies: [523.25, 659.25, 783.99], wave: "sine", noise: 0, duration_seconds: 0.7 } },
  { item_id: "system-reboot", name: "Reboot", kind: "effect", description: "Nexus is rebooting", tags: ["System"], sort_order: 895, synthesis: { frequencies: [660, 440, 330], wave: "sine", noise: 0, duration_seconds: 0.65 } },
  { item_id: "system-shutdown", name: "Shutdown", kind: "effect", description: "Nexus is shutting down", tags: ["System"], sort_order: 896, synthesis: { frequencies: [440, 330, 220], wave: "sine", noise: 0, duration_seconds: 0.75 } },

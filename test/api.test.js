...
test("serves Android app release metadata", async () => {
  ...
  assert.equal(catalog.apps.owner.versionName, "0.1.11");
  assert.equal(catalog.apps.owner.versionCode, 12);
  ...
  assert.equal(catalog.apps.player.versionName, "0.1.7");
  assert.equal(catalog.apps.player.versionCode, 8);
